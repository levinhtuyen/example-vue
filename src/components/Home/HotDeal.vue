        ...
        :perPageCustom="[[480, 1], [768, 2], [1024, 2]]">
            ...
            <slide >
                <div class="col-11 style-box-shadow">
                    <div class="col-4" style="float:left">
                        <div class="hotel-item">
                            <router-link tag="a"  :to="{ name: 'DetailHotel', params: { Sn: 2 }}"><img src="https://go2joy.vn/images/hotel/sa-mi-hotel.jpg" alt=""></router-link>
                        </div>
                    </div>
                    <div class="col-8 style-padd">
                        <p class="style-bold font-size-title">SAMI HOTEL</p>
            ...
            <slide >
                <div class="col-11 style-box-shadow">
                    <div class="col-4" style="float:left">
                        <div class="hotel-item">
                            <router-link tag="a"  :to="{ name: 'DetailHotel', params: { Sn: 3 }}"><img src="https://go2joy.vn/images/hotel/HUYNH-ANH-HOTEL.jpg" alt=""></router-link>
                        </div>
                    </div>
                    <div class="col-8 style-padd">
                        <p class="style-bold font-size-title">SAMI HOTEL</p>
            ...
            <slide >
                <div class="col-11 style-box-shadow">
                    <div class="col-4" style="float:left">
                        <div class="hotel-item">
                            <router-link tag="a"  :to="{ name: 'DetailHotel', params: { Sn: 4 }}"><img src="https://go2joy.vn/images/hotel/REDDOORZ-NEAR-TAN-SON-NHAT-AIRPORT-3.jpg" alt=""></router-link>
                        </div>
                    </div>
                    <div class="col-8 style-padd">
                        <p class="style-bold font-size-title">SAMI HOTEL</p>
            ...
            <slide >
                <div class="col-11 style-box-shadow">
                    <div class="col-4" style="float:left">
                        <div class="hotel-item">
                            <router-link tag="a"  :to="{ name: 'DetailHotel', params: { Sn: 5 }}"><img src="https://go2joy.vn/images/hotel/HA-NOI-HOTEL.jpg" alt=""></router-link>
                        </div>
                    </div>
                    <div class="col-8 style-padd">
                        <p class="style-bold font-size-title">SAMI HOTEL</p>
