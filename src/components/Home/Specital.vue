                    ...
                    <div class="col-4" style="float:left">
                        <div class="hotel-item">
                            <!-- <img class="img-lazy" :src="'https://go2joylocal.s3-ap-southeast-1.amazonaws.com/'+data1.imagePath"> -->
                             ...
                             <router-link  @click="chooseSpecitalHotel(dataHotel)"  tag="a"  :to="{ name: 'DetailHotel', params: { Sn: dataHotel.sn }}"><img src="https://go2joylocal.s3-ap-southeast-1.amazonaws.com/hotel/806_1525842113614/2_806_66_1525842113795.jpg" alt=""></router-link>
                        </div>
                    </div>
