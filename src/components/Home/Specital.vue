...
<div class="container">
    <b-row>
        ...
        <div class="col-12">
            <carousel :autoplay="true" :interval="4500" :minSwipeDistance="8" :perPageCustom="[[480, 1], [768, 2], [1024, 2]]">
                <slide>
                    <div class="col-11 style-box-shadow">
                        <div class="col-4" style="float:left">
                            <div class="hotel-item">
                                ...
                                <router-link @click="chooseSpecitalHotel(dataHotel)" tag="a" :to="{ name: 'DetailHotel', params: { Sn: 1 }}"><img src="https://go2joy.vn/images/hotel/LYLY-HOTEL.jpg" alt=""></router-link>
                            </div>
                        </div>
                        <div class="col-8 style-padd">
                            <p class="style-bold font-size-title">LYLY HOTEL</p>
                    ...
                    <div class="col-11 style-box-shadow">
                        <div class="col-4" style="float:left">
                            <div class="hotel-item">
                                <!-- <img class="img-lazy" :src="'https://go2joylocal.s3-ap-southeast-1.amazonaws.com/'+data1.imagePath"> -->
                                <!-- <img src="https://go2joylocal.s3-ap-southeast-1.amazonaws.com/hotel/806_1525842113614/2_806_66_1525842113795.jpg" alt=""> -->
                                <router-link @click="chooseSpecitalHotel(dataHotel)" tag="a" :to="{ name: 'DetailHotel', params: { Sn: 1 }}"><img src="https://go2joy.vn/images/hotel/DRAGON-HOTEL.jpg" alt=""></router-link>
                            </div>
                        </div>
                        <div class="col-8 style-padd">
                            <p class="style-bold font-size-title">LYLY HOTEL</p>
                    ...
                    <div class="col-11 style-box-shadow">
                        <div class="col-4" style="float:left">
                            <div class="hotel-item">
                                <!-- <img class="img-lazy" :src="'https://go2joylocal.s3-ap-southeast-1.amazonaws.com/'+data1.imagePath"> -->
                                <!-- <img src="https://go2joylocal.s3-ap-southeast-1.amazonaws.com/hotel/806_1525842113614/2_806_66_1525842113795.jpg" alt=""> -->
                                <router-link @click="chooseSpecitalHotel(dataHotel)" tag="a" :to="{ name: 'DetailHotel', params: { Sn: 1 }}"><img src="https://go2joy.vn/images/hotel/REDDOORZ-PLUS-TRUNG-SON-RESIDENCE.jpg" alt=""></router-link>
                            </div>
                        </div>
                        <div class="col-8 style-padd">
                            <p class="style-bold font-size-title">LYLY HOTEL</p>
                    ...
                    <div class="col-11 style-box-shadow">
                        <div class="col-4" style="float:left">
                            <div class="hotel-item">
                                <!-- <img class="img-lazy" :src="'https://go2joylocal.s3-ap-southeast-1.amazonaws.com/'+data1.imagePath"> -->
                                <!-- <img src="https://go2joylocal.s3-ap-southeast-1.amazonaws.com/hotel/806_1525842113614/2_806_66_1525842113795.jpg" alt=""> -->
                                <router-link @click="chooseSpecitalHotel(dataHotel)" tag="a" :to="{ name: 'DetailHotel', params: { Sn: 1 }}"><img src="https://go2joy.vn/images/hotel/REDDOORZ-PLUS-NEAR-LE-QUANG-DINH-STREET.jpg" alt=""></router-link>
                            </div>
                        </div>
                        <div class="col-8 style-padd">
                            <p class="style-bold font-size-title">LYLY HOTEL</p>
