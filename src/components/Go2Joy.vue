...
<div>
    ...
    <div class="col-12">
        <carousel :centerMode="false"
            ...
            <slide v-for="(data2, index) in data" :key="index" class="padd-right-15">
                <div class="col-11 style-box-shadow">
                    <div class="col-4" style="float:left">
                        <div class="hotel-item">
                            <!-- <img class="img-lazy" :src="'https://go2joylocal.s3-ap-southeast-1.amazonaws.com/'+data2.imagePath"> -->
                    ...
                    <div class="col-8 style-padd">
                        <p class="style-bold font-size-title">{{ data2.name }}</p>
                        <p class="padding-p"> <a class="style-back-cam font-size-title"><i class="fas fa-star"></i> <span> {{ data2.averageMark }} ({{ data2.totalFavorite }}) </span></a></p>
                        <p class="padding-p"><a class="style-back-xanh font-size-title"><i class="fas fa-clock"></i> <span> 0/5 </span></a></p>
                        <p class="padding-p"><a class="style-back-nau font-size-title"><i class="fas fa-map-marked"></i> <span> {{ data2.districtName }} </span></a></p>
                        ...
                        <div class="float-right style-padd-10">
                            <p><span class="style-qua-dem font-size-title"> Qua đêm </span><span class="font-size-title"> VND</span><span class="style-gia font-size-title-price">{{ data2.lowestPriceOvernight }}</span><span class="style-gia-giam font-size-title">{{ data2.lowestOneDay }}</span></p>
                        </div>
                    </div>
