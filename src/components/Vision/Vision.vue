        ...
        <section id="vision">
            <el-tabs type="border-card">
                <el-tab-pane>
                    ...
                    <div class="col-12">
                        <div class="col-6">
                            <p> Trở thành công ty tốt nhất và doanh nghiệp hàng đầu Việt Nam</p>
                        </div>
                        <div class="col-6">
                            <img class="style-img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcS04qB_WrOwb_tswbOCPHotg5gJGStTNDyHmg&usqp=CAU" alt="">
                        </div>
                    </div>

                </el-tab-pane>
                <el-tab-pane>
                    <span class="style-title" slot="label"><i class="el-icon-s-flag"></i> Sứ mệnh</span>
                    <p>Trở thành đối tác tài chính được lựa chọn và đáng tin cậy nhất của khách hàng nhờ khả năng cung cấp
                        đầy đủ các sản phẩm và dịch vụ tài chính đa dạng và dựa trên cơ sở luôn coi khách hàng làm trọng tâm.</p>
                </el-tab-pane>
                <el-tab-pane>
                    <span class="style-title" slot="label"><i class="el-icon-thumb"></i> Giá trị cốt lõi</span>
                    <p>
