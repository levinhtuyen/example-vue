...
import Specital from "./components/Specital.vue"
import Go2Joy from "./components/Go2Joy.vue"
import HotelNew from "./components/HotelNew.vue"
import Promotion from "./components/Promotion.vue"
import TopHotel from "./components/TopHotel.vue"
export default {
  name: 'App',
   components: {
        Header,
